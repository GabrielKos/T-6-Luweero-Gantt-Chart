...
export const CANONICAL_WORK_PACKAGES = [
  "Business Case Development",
  "Corporate Formation & ESIA",
  "Plant Design & Engineering Specifications of the Plant",
  "Technology Transfer Agreement",
  "Construction, Tooling, and Furnishing of the Plant",
  "Human Capital Development"
] as const;

export type CanonicalWorkPackage = typeof CANONICAL_WORK_PACKAGES[number];

export function canonicalizeWorkPackage(wp: string): string {
  if (!wp) return "Business Case Development";
  const norm = wp.trim().toLowerCase();
  if (norm.includes("business case")) return "Business Case Development";
  if (norm.includes("corporate formation") || norm.includes("esia")) return "Corporate Formation & ESIA";
  if (norm.includes("plant design") || norm.includes("engineering specification")) return "Plant Design & Engineering Specifications of the Plant";
  if (norm.includes("technology transfer")) return "Technology Transfer Agreement";
  if (norm.includes("construction") || norm.includes("tooling") || norm.includes("furnishing")) return "Construction, Tooling, and Furnishing of the Plant";
  if (norm.includes("human capital")) return "Human Capital Development";
  return wp.trim();
}
...
export const WORK_PACKAGE_STYLES: Record<string, WorkPackageStyle> = {
  ...
  "Plant Design & Engineering Specifications of the Plant": { bg: "bg-teal-500", border: "border-teal-600", light: "bg-teal-50", text: "text-teal-700" },
...
export function getWorkPackageStyle(wp: string): WorkPackageStyle {
  const canonical = canonicalizeWorkPackage(wp);
  return WORK_PACKAGE_STYLES[canonical] || DEFAULT_STYLE;
}
...
export const RAW_INITIAL_TASKS: RawTaskItem[] = [
  ...
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Develop the Plant Design Basis and Engineering Design Philosophy.", lead: "Shibah", support: "Gabriel, Renorah", dl: "2026-07-31", dur: 14 },
  ...
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Develop the preliminary Production Facility layout.", lead: "Shibah", support: "Gabriel, Renorah, Rodney", dl: "2026-08-07", dur: 14 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Develop the preliminary layout for the Quality Inspection & Testing Center.", lead: "Shibah", support: "Owen, Renorah, Gabriel", dl: "2026-08-12", dur: 14 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Develop the preliminary Inbound and Outbound Warehouse layouts.", lead: "Shibah", support: "Renorah, Gabriel, Mukama", dl: "2026-08-18", dur: 14 },
  ...
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Prepare the Design Consultant procurement documentation.", lead: "Shibah", support: "Elizabeth", dl: "2026-09-08", dur: 14 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Evaluate the technical proposals.", lead: "Shibah", support: "Owen, Gabriel, Renorah, Karen", dl: "2026-09-18", dur: 10 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Evaluate the financial proposals and negotiate with the preferred consultant.", lead: "Shibah", support: "Morgan, Donald", dl: "2026-09-25", dur: 7 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Award the Design Consultancy Contract and mobilize the Consultant.", lead: "Shibah", support: "Donald", dl: "2026-09-30", dur: 5 },
  ...
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Review and approve the Consultant's Design Work Plan and Design Program.", lead: "Entire Project Team", support: "All Members", dl: "2026-10-07", dur: 7 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Review the detailed Site Master Plan and General Arrangement Layout.", lead: "Shibah", support: "Owen, Renorah, Gabriel", dl: "2026-10-15", dur: 14 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Review the Production Facility and Manufacturing Process designs.", lead: "Shibah", support: "Owen, Gabriel, Rodney, Druscilar", dl: "2026-10-31", dur: 20 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Conduct multidisciplinary engineering design discussions.", lead: "Shibah", support: "Owen, Gabriel, Rodney, Karen, Malik, Mukama, Druscilar, Renorah", dl: "2026-10-31", dur: 20 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Consolidate engineering review comments and issues to the Design Consultant.", lead: "Shibah", support: "Owen, Gabriel, Rodney, Karen, Malik, Mukama, Druscilar, Renorah", dl: "2026-10-31", dur: 10 },
  ...
  { wp: "Corporate Formation & ESIA", act: "Continue ESIA studies, stakeholder consultations, and public engagement meetings.", lead: "Donald", support: "Owen, Shibah, Donald, Morgan", dl: "2026-11-30", dur: 20 },
  ...
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Review the Quality Inspection & Testing Center design.", lead: "Shibah", support: "Owen, Renorah, Malik, Rodney", dl: "2026-11-07", dur: 14 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Review the Inbound and Outbound Warehouse designs.", lead: "Shibah", support: "Renorah, Mukama, Gabriel", dl: "2026-11-14", dur: 14 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Review the Administration Building, Guest House, and Staff Residential designs.", lead: "Shibah", support: "Renorah, Karen", dl: "2026-11-21", dur: 14 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Review the Internal Roads, Utility Distribution Network, and Site Infrastructure designs.", lead: "Shibah", support: "Owen, Renorah, Druscilar, Rodney", dl: "2026-11-30", dur: 20 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Conduct multidisciplinary engineering design discussions.", lead: "Shibah", support: "Owen, Gabriel, Rodney, Karen, Malik, Mukama, Druscilar, Renorah", dl: "2026-11-30", dur: 20 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Consolidate engineering review comments and issues to the Design Consultant.", lead: "Shibah", support: "Owen, Gabriel, Rodney, Karen, Malik, Mukama, Druscilar, Renorah", dl: "2026-11-30", dur: 10 },
  ...
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Review the Electrical Substation and Power Distribution designs.", lead: "Shibah", support: "Owen, Gabriel, Rodney, Karen", dl: "2026-12-08", dur: 14 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Review the Water Supply, Wastewater, and Storm Water Management designs.", lead: "Shibah", support: "Owen, Gabriel, Rodney, Malik", dl: "2026-12-15", dur: 14 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Review the ICT, Communications, and Security Systems designs.", lead: "Shibah", support: "Owen, Gabriel, Druscilar", dl: "2026-12-22", dur: 14 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Review the Fire Protection and Compressed Air System designs.", lead: "Shibah", support: "Owen, Gabriel, Rodney, Mukama", dl: "2026-12-22", dur: 14 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Conduct multidisciplinary engineering design discussions.", lead: "Shibah", support: "Owen, Gabriel, Rodney, Karen, Malik, Mukama, Druscilar, Renorah", dl: "2026-12-22", dur: 20 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Consolidate engineering review comments and issues to the Design Consultant.", lead: "Shibah", support: "Owen, Gabriel, Rodney, Karen, Malik, Mukama, Druscilar, Renorah", dl: "2026-12-22", dur: 10 },
  ...
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Review the Mechanical Engineering drawings.", lead: "Shibah", support: "Owen, Gabriel, Rodney, Renorah", dl: "2027-01-22", dur: 14 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Review the Electrical Engineering drawings.", lead: "Shibah", support: "Owen, Karen, Malik, Mukama, Druscilar, Renorah", dl: "2027-01-31", dur: 14 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Conduct multidisciplinary engineering design discussions.", lead: "Shibah", support: "Owen, Gabriel, Rodney, Karen, Malik, Mukama, Druscilar, Renorah", dl: "2027-01-31", dur: 20 },
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Consolidate engineering review comments and issues to the Design Consultant.", lead: "Shibah", support: "Owen, Gabriel, Rodney, Karen, Malik, Mukama, Druscilar, Renorah", dl: "2027-01-31", dur: 10 },
  ...
  { wp: "Plant Design & Engineering Specifications of the Plant", act: "Conduct multidisciplinary engineering design discussions.", lead: "Shibah", support: "Owen, Gabriel, Rodney, Karen, Malik, Mukama, Druscilar, Renorah", dl: "2027-02-21", dur: 20 },
